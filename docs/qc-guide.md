...
1) **Good BET (Brain Extraction Tool) Segmentation**
   ...
   ![image](../assets/figures/good-bet.png)
...
2) **Good MNI wrap**
   ...
   ![image](../assets/figures/good-mni.png)
...
1) **b=0 reference image**
   ...
   ![image](../assets/figures/qsiprep_brainmask.png)
...
2) **DWI sampling Scheme**
   ...
   ![image](../assets/figures/qsiprep_qspace.png)
...
3) **b=0 to anatomical reference registration**
   ...
   ![image](../assets/figures/qsiprep_motion.png)
...
4) **DWI summary**
   ...
   ![image](../assets/figures/qsiprep_FD.png)
