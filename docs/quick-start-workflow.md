...
After you are done with stage 6, verify your data/share folder using [share-folder-checklist.md](share-folder-checklist.md). Ensure all folders and files match the checklist. Once confirmed, copy your folder into the shared space.
