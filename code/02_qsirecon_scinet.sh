...
export WORK_DIR=${BASEDIR}/qsiprep
...
DTIFIT_OUT=${OUTPUT_DIR}/dtifit/sub-${SUBJECTS}/ses*/dwi/sub-${SUBJECTS}_ses-0*_acq-singleshelldir60b1000_run-1_space-T1w_desc-preproc_fslstd
...
singularity run \
  ...
  ${ENIGMA_CONTAINER} \
  --calc-all --debug \
  /enigma_dir/sub-${SUBJECTS}_ses-0*\
