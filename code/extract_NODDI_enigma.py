...
def run_non_FA(NODDItag, outputdir, enigmadir, subject, session):
	...
	#FA_stem = "{}_{}_acq-singleshelldir60b1000_run-1_space-T1w_desc-preproc_fslstd_FA".format(subject, session)    
    else:
	...
	#FA_stem = "{}_acq-singleshelldir60b1000_run-1_space-T1w_desc-preproc_fslstd_FA".format(subject)
