...
|-------|------|------|-------------------|
| 🛠️ | 0a | [Setting up the SciNet environment](#setting-your-scinet-environment-and-prepare-your-dataset) | ~30 minutes |
...
| 1️⃣ | 01a | [Run MRIQC](#running-mriqc) | ~8 hours on Slurm |
...
| 2️⃣ | 02a | [Run fMRIPrep apply](#running-fmriprep-apply) | ~3 hours on Slurm |
...
| 3️⃣ | 03a | [Run xcp-d](#running-xcp-d) | ~5 hours on Slurm |
...
| 4️⃣ | 04a | [Run ENIGMA-DTI](#running-enigma-dti) | ~1 hour on Slurm |
| | 04b | [Check TSV file](#check-tsv-file) | — |
| 5️⃣ | 05a | [Run extract-NODDI](#running-extract-noddi) | ~3 hours on Slurm |
| | 05b | [Check TSV file](#check-tsv-file) | — |
| 📤 | 06a | [Extract and share to consortium folder](#syncing-the-data-to-the-share-directory) | ~8 hours on Slurm (Slurm + login-node scripts together) |
