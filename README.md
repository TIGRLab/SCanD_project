...
|^ |   01d	|   [Move you bids data to the corrent place and add lables to participants.tsv file](#put-your-bids-data-into-the-datalocal-folder)	| depends on time to transfer data to SciNet  	|
