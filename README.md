...
This branch targets the **SciNet Nibi** cluster. Use the matching git branch when cloning (`nibi`, `trillium`, or `Fir` for other clusters).
...
|-------|------|------|-------------------|
| **Stage 🛠️** | 0a | [Setting up the SciNet environment](#setting-your-scinet-environment-and-prepare-your-dataset) | ~30 minutes |
...
| **Stage 1️⃣** | 01a | [Run MRIQC](#running-mriqc) | ~8 hours on Slurm |
...
| **Stage 2️⃣** | 02a | [Run fMRIPrep apply](#running-fmriprep-apply) | ~3 hours on Slurm |
...
| **Stage 3️⃣** | 03a | [Run xcp-d](#running-xcp-d) | ~5 hours on Slurm |
...
| **Stage 4️⃣** | 04a | [Run ENIGMA-DTI](#running-enigma-dti) | ~1 hour on Slurm |
| | 04b | [Check TSV file](#check-tsv-file) | — |
| **Stage 5️⃣** | 05a | [Run extract-NODDI](#running-extract-noddi) | ~3 hours on Slurm |
| | 05b | [Check TSV file](#check-tsv-file) | — |
| **Stage 📤** | 06a | [Extract and share to consortium folder](#syncing-the-data-to-the-share-directory) | ~8 hours on Slurm (Slurm + login-node scripts together) |
...
To link existing data from another location on SciNet Nibi to this folder:
...
You customize how your dataset is structured by editing the YAML file. An example of the config file can be found [here](https://github.com/TIGRLab/SCanD_project/blob/nibi/code/config/EPIPHANI_query_config.yaml)
